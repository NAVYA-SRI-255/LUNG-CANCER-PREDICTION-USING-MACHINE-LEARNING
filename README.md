...
## 📌 Key Insights
- Logistic Regression and Random Forest achieved the highest accuracy (96.77%)  
- SVM performed slightly lower (95.16%)  
- The dataset is imbalanced with very few “No Cancer” cases  
...
## 🧪 Example Prediction
Input: Age = 60, Smoking = YES, Fatigue = YES  
...
- Model performance on minority class is lower  
